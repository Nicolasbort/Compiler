  ...
  try {
    ...
    dynamic_cast<St_attribContext *>(_localctx)->ex = expression();
            ...
            if (it == symbol_table.end())
            {
                ...
                type_table.push_back(dynamic_cast<St_attribContext *>(_localctx)->ex->type);
            ...
            if (dynamic_cast<St_attribContext *>(_localctx)->ex->type != type) {
                switch (type) {
                    case 's':
                        ...
                        break;
                    case 'i':
                        cerr << "Error: Line " << _localctx->getStart()->getLine() << " - '" << (dynamic_cast<St_attribContext *>(_localctx)->ex != nullptr ? _input->getText(dynamic_cast<St_attribContext *>(_localctx)->ex->start, dynamic_cast<St_attribContext *>(_localctx)->ex->stop) : nullptr) << "' is an " << dynamic_cast<St_attribContext *>(_localctx)->ex->type << "\n";
...
ExpParser::Str_array_createContext* ExpParser::str_array_create() {
  ...
  try {
    ...
    match(ExpParser::CL_BRA);
            ...
            auto it = find(symbol_table.begin(), symbol_table.end(), (dynamic_cast<Str_array_createContext *>(_localctx)->nameToken != nullptr ? dynamic_cast<Str_array_createContext *>(_localctx)->nameToken->getText() : ""));
            ...
            if (it == symbol_table.end())
            {
                ...
                cerr << "Error: Line " << _localctx->getStart()->getLine() << " - '" << (dynamic_cast<Str_array_createContext *>(_localctx)->nameToken != nullptr ? dynamic_cast<Str_array_createContext *>(_localctx)->nameToken->getText() : "") << "' is already declared\n";
  ...
  try {
    ...
    match(ExpParser::OP_PAR);
            ...
            if (type == 'a') 
                ...
                cerr << "Error: Line " << _localctx->getStart()->getLine() << " - Name '" << (dynamic_cast<St_array_pushContext *>(_localctx)->nameToken != nullptr ? dynamic_cast<St_array_pushContext *>(_localctx)->nameToken->getText() : "") << "' is not an array\n";
            }
...
ExpParser::St_array_setContext* ExpParser::st_array_set() {
  ...
  try {
    ...
    match(ExpParser::OP_BRA);
            ...
            if (it == symbol_table.end())
            {
                cerr << "Error: Line " << _localctx->getStart()->getLine() << " - '" << (dynamic_cast<St_array_setContext *>(_localctx)->nameToken != nullptr ? dynamic_cast<St_array_setContext *>(_localctx)->nameToken->getText() : "") << "' is not defined\n";
            }
            else
            {
                int index = distance(symbol_table.begin(), it);
                ...
                if (type != 'a')
                    cerr << "Error: Line " << _localctx->getStart()->getLine() << " - '" << (dynamic_cast<St_array_setContext *>(_localctx)->nameToken != nullptr ? dynamic_cast<St_array_setContext *>(_localctx)->nameToken->getText() : "") << "' is not array\n";
                else
                    calculateStack("aload " + to_string(index), 1);
            }
    ...
    dynamic_cast<St_array_setContext *>(_localctx)->ex2 = expression();
            ...
            else if (dynamic_cast<St_array_setContext *>(_localctx)->ex1->type != 'i')
                cerr << "Error: Line " << _localctx->getStart()->getLine() << " - Array index must be an integer\n";
            else if (dynamic_cast<St_array_setContext *>(_localctx)->ex2->type != 'i')
                cerr << "Error: Line " << _localctx->getStart()->getLine() << " - '" << (dynamic_cast<St_array_setContext *>(_localctx)->nameToken != nullptr ? dynamic_cast<St_array_setContext *>(_localctx)->nameToken->getText() : "") << "' is array\n";
...
ExpParser::ComparisionContext* ExpParser::comparision() {
  ...
  try {
    ...
    dynamic_cast<ComparisionContext *>(_localctx)->ex2 = expression();
            ...
            {
                cerr << "Error: Line " << _localctx->getStart()->getLine() << " - cannot mix types\n";
  ...
  try {
    ...
    || _la == ExpParser::MINUS) {
      ...
      dynamic_cast<ExpressionContext *>(_localctx)->t2 = term();
              ...
              if (dynamic_cast<ExpressionContext *>(_localctx)->t1->type != dynamic_cast<ExpressionContext *>(_localctx)->t2->type) {
                  cerr << "Error: Line " << _localctx->getStart()->getLine() << " - cannot mix types\n";
              } 
              else {
    ...
    case 4: {
      ...
      dynamic_cast<FactorContext *>(_localctx)->nameToken = match(ExpParser::NAME);
              ...
              if (type == 'i')
                  ...
                  cerr << "Error: Line " << _localctx->getStart()->getLine() << " - Name type invalid\n";
      ...
      match(ExpParser::CL_BRA);
              ...
              else
              {
                  if (dynamic_cast<FactorContext *>(_localctx)->expressionContext->type != 'i') {
                      cerr << "Error: Line " << _localctx->getStart()->getLine() << " - '" << (dynamic_cast<FactorContext *>(_localctx)->expressionContext != nullptr ? _input->getText(dynamic_cast<FactorContext *>(_localctx)->expressionContext->start, dynamic_cast<FactorContext *>(_localctx)->expressionContext->stop) : nullptr) << "' must be an integer\n";
                  } else {
                      int index = distance(symbol_table.begin(), it);
                      used_vars[index] = true;
                      char type = type_table[index];
...
ExpParser::Initializer::Initializer() {
  ...
  _serializedATN = {
    ...
    0x3, 0x27, 0xcf, 0x4, 0x2, 0x9, 0x2, 0x4, 0x3, 0x9, 0x3, 0x4, 0x4, 0x9, 
    ...
    0x11, 0x3, 0x11, 0x3, 0x11, 0x3, 0x11, 0x3, 0x11, 0x3, 0x11, 0x3, 0x11, 
    0x3, 0x11, 0x3, 0x11, 0x3, 0x11, 0x3, 0x11, 0x3, 0x11, 0x5, 0x11, 0xcd, 
    0xa, 0x11, 0x3, 0x11, 0x2, 0x2, 0x12, 0x2, 0x4, 0x6, 0x8, 0xa, 0xc, 
    0xe, 0x10, 0x12, 0x14, 0x16, 0x18, 0x1a, 0x1c, 0x1e, 0x20, 0x2, 0x5, 
    0x3, 0x2, 0x14, 0x19, 0x3, 0x2, 0x6, 0x7, 0x3, 0x2, 0x8, 0xa, 0x2, 0xd5, 
    0x2, 0x22, 0x3, 0x2, 0x2, 0x2, 0x4, 0x25, 0x3, 0x2, 0x2, 0x2, 0x6, 0x36, 
    0x3, 0x2, 0x2, 0x2, 0x8, 0x38, 0x3, 0x2, 0x2, 0x2, 0xa, 0x4a, 0x3, 0x2, 
    0x2, 0x2, 0xc, 0x4f, 0x3, 0x2, 0x2, 0x2, 0xe, 0x67, 0x3, 0x2, 0x2, 0x2, 
    0x10, 0x74, 0x3, 0x2, 0x2, 0x2, 0x12, 0x77, 0x3, 0x2, 0x2, 0x2, 0x14, 
    0x7a, 0x3, 0x2, 0x2, 0x2, 0x16, 0x80, 0x3, 0x2, 0x2, 0x2, 0x18, 0x89, 
    0x3, 0x2, 0x2, 0x2, 0x1a, 0x92, 0x3, 0x2, 0x2, 0x2, 0x1c, 0x97, 0x3, 
    0x2, 0x2, 0x2, 0x1e, 0xa3, 0x3, 0x2, 0x2, 0x2, 0x20, 0xcc, 0x3, 0x2, 
    0x2, 0x2, 0x22, 0x23, 0x8, 0x2, 0x1, 0x2, 0x23, 0x24, 0x5, 0x4, 0x3, 
    0x2, 0x24, 0x3, 0x3, 0x2, 0x2, 0x2, 0x25, 0x27, 0x8, 0x3, 0x1, 0x2, 
    0x26, 0x28, 0x5, 0x6, 0x4, 0x2, 0x27, 0x26, 0x3, 0x2, 0x2, 0x2, 0x28, 
    0x29, 0x3, 0x2, 0x2, 0x2, 0x29, 0x27, 0x3, 0x2, 0x2, 0x2, 0x29, 0x2a, 
    0x3, 0x2, 0x2, 0x2, 0x2a, 0x2b, 0x3, 0x2, 0x2, 0x2, 0